<!-- Main content -->
	  ...
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Reg Code <?php echo form_error('reg_code') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="reg_code" id="reg_code" placeholder="Reg Code" value="<?php echo $reg_code; ?>" />
                                   </div> 
                                </div>
	  ...
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Birth Date <?php echo form_error('birth_date') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="birth_date" id="birth_date" placeholder="Birth Date" value="<?php echo $birth_date; ?>" />
                                   </div> 
                                </div>
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Period <?php echo form_error('period') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="period" id="period" placeholder="Period" value="<?php echo $period; ?>" />
                                   </div> 
                                </div>
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Class Type Id <?php echo form_error('class_type_id') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="class_type_id" id="class_type_id" placeholder="Class Type Id" value="<?php echo $class_type_id; ?>" />
                                   </div> 
                                </div>
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Classroom Id <?php echo form_error('classroom_id') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="classroom_id" id="classroom_id" placeholder="Classroom Id" value="<?php echo $classroom_id; ?>" />
                                   </div> 
                                </div>
