<!-- Main content -->
	  ...
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Ship Status <?php echo form_error('ship_status') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="ship_status" id="ship_status" placeholder="Ship Status" value="<?php echo $ship_status; ?>" disabled/>
                                   </div> 
                                </div>
	 ...
	 <div style='text-align: left;'>
	    <a href="<?php echo site_url('shipment') ?>" class="btn btn-default">Cancel</a>
	</div>
                        </div>
                    </div>
                  </div>
